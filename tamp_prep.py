...
def set_up(file_name):
    ...
    robot_3 =  agent(agent_id=0,agent_name="robot_3", step_num = 0, curr_path = agent_paths[0], status ="work")
    robot_1 = agent(agent_id=1,agent_name="robot_1", step_num = 0, curr_path = agent_paths[1], status ="work")
...
def step(agent):
    ...
    if agent.status == "work":
        ...
        step_look_up(agent, curr_step, next_step)
        try:
